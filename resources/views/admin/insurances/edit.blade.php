...
<div class="card">
    <div class="card-header">
        <h5>Edit Insurance Plan: {{ $insurance->name }}</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.insurances.update', $insurance->insurance_id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea name="coverage_details" class="form-control @error('coverage_details') is-invalid @enderror" 
                              rows="4" required>{{ old('coverage_details', $insurance->coverage_details) }}</textarea>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" step="0.01" name="daily_rate" class="form-control @error('daily_rate') is-invalid @enderror" 
                           value="{{ old('daily_rate', $insurance->daily_rate) }}" required>
